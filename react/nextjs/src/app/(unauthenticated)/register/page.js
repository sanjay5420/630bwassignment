    ...
    >
      {({ errors, touched,handleChange}) => (
        ...
        <Form className='flex flex-col gap-4 '>
          ...
          <Button type="submit" className='bg-blue-400 text-white'>Register</Button>
          <p className='text-sm'>Already have an account ? <Link className='font-bold' href={"/"}>Login.</Link> </p>
        </Form>
      )}
    </Formik>
    </Card>
